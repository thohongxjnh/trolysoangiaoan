...
<div class="main-header">
    ...
    <p>Tác giả: Nguyễn Thị Xuân - Trường TH Cầu Ham - ĐT: 0913849892 </p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nguyễn Thị Xuân - Trường TH Cầu Ham - ĐT: 0913949892</div>", unsafe_allow_html=True)
